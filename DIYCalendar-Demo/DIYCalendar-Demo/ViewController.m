...
- (IBAction)btnHandler:(UIButton *)sender {
    ...
    [calendarVC setup:DJChooseTypeMuti minDate:@"2011-01-05" maxDate:@"2016-12-11" block:^(DJChooseType chooseType, DJCalendarType calendarType, NSString *startDate, NSString *endDate, NSString *labelStr) {
